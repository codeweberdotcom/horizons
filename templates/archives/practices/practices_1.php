...
if ($categories && !is_wp_error($categories)) :
   ...
   foreach ($categories as $category) :
      ...
      // Если изображение справа (четные), контент слева - нужен pe-md-12
      // Если изображение слева (нечетные), контент справа - нужен ps-md-12
      $content_order = ($counter % 2 == 0) ? 'order-lg-1 py-8 px-0 py-md-12 pe-md-12' : 'order-lg-2 py-8 px-0 py-md-12 ps-md-12';
