      ...
      if ($categories && !is_wp_error($categories)) {
         ...
         foreach ($categories as $category) {
            ...
            foreach ($partner_posts as $post) {
               ...
               echo '<li><a class="label-s text-neutral-500 my-1 d-block ' . $active_class . '" href="' . esc_url($permalink) . '">' . esc_html(get_the_title($post)) . '</a></li>';
            }
...
<?php
      ...
      if ($categories && !is_wp_error($categories)) {
         ...
         foreach ($categories as $category) {
            ...
            echo '<li class="mt-0"><a class="label-s text-neutral-500 my-1 d-block' . $active_class . '" href="' . esc_url(get_single_filter_url('category', $category->slug)) . '">' . esc_html($category->name) . ' <span class="text-muted">(' . $category->count . ')</span></a></li>';
         }
      ...
      if (!empty($years)) {
         ...
         foreach ($years as $year_data) {
            ...
            echo '<li class="mt-0"><a class="label-s text-neutral-500 my-1 d-block ' . $active_class . '" href="' . esc_url(get_single_filter_url('year', $year_data['year'])) . '">' . esc_html($year_data['year']) . ' <span class="text-muted">(' . $year_data['count'] . ')</span></a></li>';
         }
      ...
      if (!empty($partners_with_awards)) {
         ...
         foreach ($partners_with_awards as $partner) {
            ...
            echo '<li class="mt-0"><a class="label-s text-neutral-500 my-1 d-block ' . $active_class . '" href="' . esc_url(get_single_filter_url('partner', $partner->ID)) . '">' . esc_html($partner->post_title) . '</a></li>';
         }
